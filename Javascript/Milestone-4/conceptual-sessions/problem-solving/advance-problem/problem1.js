...
function imageExtensions(photoName, extensions){
    if(typeof photoName !== "string"){
        return "please provide a valid photo name"
    }else if(!Array.isArray(extensions)){
        return "please provide a valid array"
    }else {
        for(let iteam of extensions){
            if(photoName.toLowerCase().endsWith(iteam.toLowerCase())){
                return true
            }
        }
        return false;
...
const extensions = ["jpg", "png", "gif", "JPEG", "ico"];
const photoName = "bg.jpeg";
const result = imageExtensions(photoName, extensions);
console.log(result);